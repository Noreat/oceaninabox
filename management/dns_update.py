...
def build_zone(domain, domain_properties, additional_records, env, is_zone=True):
	...
	if domain_properties[domain]["mail"] \
	  ...
	  and is_domain_cert_signed_and_valid("mta-sts." + domain, env):
		...
		with open("/var/lib/Ocean3inaBox/mta-sts.txt", "rb") as f:
...
def build_tlsa_record(env):
	...
	# and https://github.com/Ocean3inaBox/Ocean3inaBox/issues/268#issuecomment-167160243.
	#
	...
	# generate a private key once the first time Ocean3inaBox is set up
