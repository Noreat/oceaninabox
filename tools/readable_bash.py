...
<html>
    ...
    <div class="container">
      <div class="row intro">
        ...
        <p>This document is generated automatically from <a href="https://Ocean3inaBox.email">Ocean3inaBox</a>&rsquo;s setup script <a href="https://github.com/Ocean3inaBox/Ocean3inaBox">source code</a>.</p>
        <hr>
      </div>
    </div>
...
class OtherLine(Grammar):
	...
	def value(self):
		...
		if "source /etc/Ocean3inaBox.conf" in self.string: return ""
		return "<pre class='shell'><div>" + recode_bash(self.string.strip()) + "</div></pre>\n"
...
class BashScript(Grammar):
	...
	@staticmethod
	def parse(fn):
		if fn in {"setup/functions.sh", "/etc/Ocean3inaBox.conf"}: return ""
		...
		return v.replace("`pwd`",  "<code><b>/path/to/Ocean3inaBox</b></code>")
