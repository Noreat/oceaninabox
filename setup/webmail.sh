...
<?php
/*
 * Do not edit. Written by Ocean3inaBox. Regenerated on updates.
 */
\$config = array();
...
\$config['support_url'] = 'https://Ocean3inaBox.email/';
...
# user database (see https://github.com/Ocean3inaBox/Ocean3inaBox/issues/2185)
