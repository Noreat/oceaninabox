...
The maintainers of Ocean3inaBox share the dual responsibility of leading by example and enforcing these policies as necessary to maintain an open and welcoming environment. All community members should be excellent to each other.

## Scope

This Code of Conduct applies to all places where Ocean3inaBox community activity is occurring, including on GitHub, in discussion forums, on Slack, on social media, and in real life. The Code of Conduct applies not only on websites/at events run by the Ocean3inaBox community (e.g. our GitHub organization, our Slack team) but also at any other location where the Ocean3inaBox community is present (e.g. in issues of other GitHub organizations where Ocean3inaBox community members are discussing problems related to Ocean3inaBox, or real-life professional conferences), or whenever a Ocean3inaBox community member is representing Ocean3inaBox to the public at large or acting on behalf of Ocean3inaBox.

This code does not apply to activity on a server running Ocean3inaBox software, unless your server is hosting a service for the Ocean3inaBox community at large.
...
Because the need for confidentiality for all parties involved in an enforcement action outweighs the goals of openness, limited information will be shared with the Ocean3inaBox community regarding enforcement actions that have taken place.
